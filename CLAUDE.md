...
- Login-Umbau (beschlossen 2026-09-04, alle 6 PRs/Issues #73–#78 umgesetzt): kein Login-Zwang
  ...
  Aktivität startbar (TTL-Policy selbst noch nicht in der Firebase Console konfiguriert, siehe
  Status im Plan), plus neues In-Game-Menü (Speichern/Spielstände laden/Verlassen/"Meine
  Spiele"/Account verknüpfen): `docs/done/login-multiplayer-onboarding-plan.md`
