...
export const tutorialSteps: TutorialStep[] = [
  {
    ...
    body:
      'Ihr erkundet gemeinsam einen Dungeon und müsst jeden Encounter innerhalb eines ' +
  ...
  },
  {
    ...
    body:
      'Im Singleplayer spielt ihr allein gegen die Uhr. Ihr könnt euch jederzeit "ausruhen", ' +
  ...
  },
  {
    ...
    body:
      'Mit "Neues Multiplayer-Spiel" startet ihr einen Dungeon für eure Gruppe und teilt den ' +
  ...
  },
  {
    title: 'Heldenauswahl',
    body:
      'Vor dem ersten Encounter wählt jeder Spieler einen Helden mit eigenem Kartenstapel ' +
  ...
  },
  {
    title: 'Dungeon-Timer',
    body:
      'Sobald die erste Karte wirksam gespielt wird, startet ein 5-Minuten-Countdown - läuft ' +
  ...
  },
  {
    ...
    body:
      'Jeder Encounter zeigt Symbol-Token, die ihr passenden Handkarten mit demselben ' +
  ...
  },
  {
    ...
    body:
      'Tippt oder klickt auf eine Handkarte, um sie gegen ein passendes Encounter-Symbol ' +
  ...
  },
  {
    ...
    body:
      'Über den Kreis-Button unten rechts öffnet ihr eure Heldenfähigkeit - jeder Held hat ' +
  ...
  },
  {
    ...
    body:
      'Besiegt ihr einen Boss, entscheidet ihr per Bestätigung, ob es in den nächsten Dungeon ' +
  ...
  },
  {
    ...
    body:
      'Das war’s mit den Grundlagen - ihr könnt dieses Tutorial jederzeit über den Hilfe-' +
