...
describe('GameComponent', () => {
  ...
  beforeEach(async () => {
    ...
    imports: [MatDialogModule, NgxsModule.forRoot([CurrentGameState, CurrentUserState, heropowerState, JokerSelectionState, CardStackState, cardsInHandState, DeliveryStackState, LobbyState, EncounterState]), GameComponent],
