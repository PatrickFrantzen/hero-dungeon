...
describe('GameComponent', () => {
  ...
  beforeEach(async () => {
    ...
    imports: [MatDialogModule, NgxsModule.forRoot([CurrentGameState, CurrentUserState, heropowerState, CardStackState, cardsInHandState, DeliveryStackState, LobbyState]), GameComponent],
