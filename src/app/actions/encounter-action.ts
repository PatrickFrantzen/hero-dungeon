...
export class UpdateMonsterTokenArray {
  static readonly type =
    '[Player Hand page] Updating the token Array of a Monster';
...
export class SetCurrentBoss {
  static readonly type =
    '[Card play service] setting the current boss for the campaign';
  constructor(public currentBoss: Mob) {}
}

export class SetRemainingBosses {
  static readonly type =
    '[Card play service] setting the remaining bosses in the campaign';
